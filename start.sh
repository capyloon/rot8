...
#    echo "exec swaymsg \"input 1046:1158:Goodix_Capacitive_TouchScreen map_to_output DSI-1\"" >> /tmp/capyloon_sway.config
#    echo "exec \"/home/capyloon/dev/rot8/target/release/rot8 --sleep 2000 --normalization-factor 1e4 --display DSI-1 2> /tmp/capyloon_rot8.log\"" >> /tmp/capyloon_sway.config
    ...
    sway -d -c /tmp/capyloon_sway.config 2>&1 >> /tmp/capyloon_sway.log &
